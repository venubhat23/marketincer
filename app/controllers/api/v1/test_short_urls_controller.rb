class Api::V1::TestShortUrlsController < ApplicationController
  ...
  # GET /api/v1/test/users/:user_id/urls
  def index
  ...
  # GET /api/v1/test/users/:user_id/dashboard
  def dashboard
    render json: {
      user_id: @current_user.id,
  ...
  def set_test_user
    # For testing, use the first user or create a test user
